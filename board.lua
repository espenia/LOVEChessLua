...
function Board:whitePiecesDefault(pieces)
    ...
    self:addPiece(Knight("w", step, 0, step, xOffset, yOffset, 2, 1))
    self:addPiece(Knight("w", boardEnd - 2 *step, 0, step, xOffset, yOffset, 7, 1))
    self:addPiece(Bishop("w", 2 * step, 0, step, xOffset, yOffset, 3, 1))
...
function Board:blackPiecesDefault(pieces)
    ...
    self:addPiece(Knight("b", step, boardEnd - step, step, xOffset, yOffset, 2, 8))
    self:addPiece(Knight("b", boardEnd - 2 *step, boardEnd - step, step, xOffset, yOffset, 7, 8))
    self:addPiece(Bishop("b",  2 * step, boardEnd - step, step, xOffset, yOffset, 3, 8))
